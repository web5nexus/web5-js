...
export interface Web5jsConfig {
  ...
  /**
   * API Version of Web5js. Use V3 for api.tatum.io/v3 API keys and V4 for api.tatum.io/v4 API keys. Defaults to V4.
   */
  version?: ApiVersion

  /**
   * Enter your API Key here. You can get it from https://dashboard.web5.nexus
   ...
   * If you are using Web5js API Key, you can use Web5js SDK without any limitations.
   */
  apiKey?: {
    /**
  ...
  rpc?: {
    ...
    /**
     * If this parameter is set, then the SDK will use this URL for all RPC calls. If this parameter is not set, then the SDK will RPC provisioned by Web5js. List of supported blockchains is available [here](https://docs.web5.nexus).
     */
    nodes?: RpcNode[]
  ...
  /**
   * Optional list of Web5jsSdkExtensions.
   */
  configureExtensions?: ExtensionConstructorOrConfig[]

  /**
   * Optional list of Web5jsSdkWalletExtensions.
   */
