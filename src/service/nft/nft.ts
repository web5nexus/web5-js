...
export class NftTezos {
   ...
   * You don't have to have any funds on the address, as the smart contract is deployed by Web5js.
...
export class Nft {
   ...
   * You don't need to specify the default minter of the collection, as the owner of the collection is the default minter.
   * You don't have to have any funds on the address, as the nft is minted by Web5js.
   * @param body Body of the request.
