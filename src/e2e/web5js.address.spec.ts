...
describe.skip('Address', () => {
  describe('Address Balance', () => {
    describe('getBalance EVM', () => {
      ...
      it('should get balance with native assets only', async () => {
        const { data } = await web5js.address.getBalance({
    ...
    describe('getBalance SOL', () => {
      let web5js: Solana
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Solana>({ network: Network.SOLANA_DEVNET })
      })
    ...
    describe('getBalance BTC', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Bitcoin>({ network: Network.BITCOIN_TESTNET })
      })
    ...
    describe('getBalance DOGE', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Dogecoin>({ network: Network.DOGECOIN_TESTNET })
      })
    ...
    describe('getBalance LTC', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Litecoin>({ network: Network.LITECOIN_TESTNET })
      })
    ...
    describe('getBalance CARDANO', () => {
      ...
      beforeAll(async () => {
        web5js = await Web5jsSDK.init({ network: Network.CARDANO_ROSETTA_PREPROD })
      })
    ...
    describe('getBalance XRP', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init({ network: Network.XRP_TESTNET })
      })
      ...
      it('should get balance with native assets only', async () => {
        const response = await web5js.address.getBalance({
    ...
    describe('getBalance Tezos', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Tezos>({
          network: Network.TEZOS,
        })
      })

      it('should get all balances for address', async () => {
        const { data } = await web5js.address.getBalance({ address: 'tz1irJKkXS2DBWkU1NnmFQx1c1L7pbGg4yhk' })
    ...
    describe('getBalance Tron', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Tron>({
    ...
    describe('getBalance EON', () => {
      let web5js: HorizenEon

      beforeEach(async () => {
        web5js = await Web5jsSDK.init({
  ...
  describe('getTransactions', () => {
    describe('getTransactions EVM', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Ethereum>({ network: Network.ETHEREUM_SEPOLIA })
      })
      ...
      it('should get transactions - native only', async () => {
        const txs = await web5js.address.getTransactions({
          address: '0x514D547c8aC8ccBEc29b5144810454BD7d3625CA',
      ...
      it('should get transactions - pagination', async () => {
        const page1 = await web5js.address.getTransactions({
          address: '0x514D547c8aC8CCBEc29B5144810454BD7D3625cB',
          pageSize: 1,
        })
        const page2 = await web5js.address.getTransactions({
          address: '0x514D547c8aC8CCBEc29B5144810454BD7D3625cB',
          pageSize: 1,
          page: 1,
        })
    ...
    describe('getTransactions Tezos', () => {
      ...
      beforeEach(async () => {
        web5js = await Web5jsSDK.init<Tezos>({ network: Network.TEZOS })
      })
