...
describe.skip('Web5js token', () => {
  ...
  describe('token balances', () => {
    it('should get token balances', async () => {
      const { data: balance } = await web5js.token.getBalance({
  ...
  describe('token transactions', () => {
    it('should get ERC20 transactions for address for all tokens', async () => {
      const { data: txs } = await web5js.token.getAllFungibleTransactions({
        addresses: ['0x2cbaf358c0af93096bd820ce57c26f0b7c6ec7ab'],
      })
    ...
    it('should get ERC20 transactions for address for specific token', async () => {
      ...
      const { data: txs2 } = await web5js.token.getAllFungibleTransactions({
        addresses: ['0x2cbaf358c0af93096bd820ce57c26f0b7c6ec7ab'],
        tokenAddress: '0x5169fe503d6dacb7ac0495faa342ee9731892490',
      })
      expect(txs).toHaveLength(1)
      ...
      const { data: wrongSC } = await web5js.token.getAllFungibleTransactions({
        addresses: ['0x2cbaf358c0af93096bd820ce57c26f0b7c6ec7ab'],
  ...
  describe('Token metadata', () => {
    it('should get ERC20 token metadata', async function () {
      const { data: metadata } = await web5js.token.getTokenMetadata({
        tokenAddress: '0x5169fe503d6dacb7ac0495faa342ee9731892490',
      })
  ...
  describe('Create token', () => {
    it.skip('should create ERC20 token', async () => {
      const result = await web5js.token.createNewFungibleToken({
        name: 'Test Token',
        symbol: 'TSTERC20_2',
